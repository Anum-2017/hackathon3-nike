  ...
  return (
    <div className='grid grid-cols-12 px-8 md:px-20 my-16 md:my-16 gap-6'>
      ...
      <div className='col-span-12 md:col-span-6 pr-18 pt-10 md:pt-0'>
        ...
        {/* <h3 className="font-bold text-2xl focus-visible:outline-none mb-4">Inventory: {product.inventory</h3>*/}
        {product.colors && (
          <div className="mb-4">
        ...
        <div className='flex mt-6'>
          <Button onClick={handleAddToCart} className="rounded-full bg-black px-12 py-6 text-white text-lg">Add to cart</Button>
        </div>
        {notification && (
